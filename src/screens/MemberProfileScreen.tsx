...
const s=StyleSheet.create({
 ...
 coverWrap:{height:210,position:'relative'},cover:{width:'100%',height:'100%'},coverShade:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(0,0,0,.25)'},backButton:{position:'absolute',left:14,top:12,width:42,height:42,borderRadius:21,backgroundColor:'rgba(4,9,17,.78)',alignItems:'center',justifyContent:'center'},
