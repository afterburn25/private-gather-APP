...
module.exports = ({ config }) => {
  ...
  return {
    ...
    runtimeVersion: process.env.PG_NATIVE_RUNTIME_VERSION || (messenger?'pg-messenger-native-2':'pg-native-2'),
    updates: {
      ...(base.updates || {}),
      ...(config.updates || {}),
      enabled: true,
    ...
    ios: {
      ...
      icon: messenger?'./assets/messenger-ios-icon.png':(((config.ios||{}).icon)||((base.ios||{}).icon)),
      infoPlist:{
        ...((base.ios||{}).infoPlist||{}),
    ...
    android: {
      ...
      icon: messenger?'./assets/messenger-icon.png':(((config.android||{}).icon)||((base.android||{}).icon)),
      adaptiveIcon: messenger?{foregroundImage:'./assets/messenger-adaptive-icon.png',backgroundColor:'#050914'}:(((config.android||{}).adaptiveIcon)||((base.android||{}).adaptiveIcon)),
    ...
    icon: messenger?'./assets/messenger-ios-icon.png':(config.icon||base.icon),
    plugins,
    extra: {
      ...(base.extra || {}),
      ...(config.extra || {}),
